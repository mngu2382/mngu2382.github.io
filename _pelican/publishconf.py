...
SITEURL = u'https://mngu2382.github.io'
...
STATIC_PATHS = [u'images', u'favivon.ico']
EXTRA_PATH_METADATA = {u'favicon.ico': {u'path': u'favicon.ico'}}
...
# Custom variables
MATHJAX_URL = u'https://c328740.ssl.cf1.rackcdn.com/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML'
